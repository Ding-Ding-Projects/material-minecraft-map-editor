...
(function () {
  ...
  var CSS = [
    ...
    // Vertical rails
    ':root[data-tab-dock="left"] .tab-bar,:root[data-tab-dock="right"] .tab-bar{position:fixed;top:0;bottom:0;width:var(--tab-rail-width);flex-direction:column;flex-wrap:nowrap;align-items:stretch;justify-content:flex-start;gap:10px;overflow:auto;z-index:45;border-bottom:0}',
    ...
    ':root[data-tab-dock="left"] #tab-strip,:root[data-tab-dock="right"] #tab-strip{flex-direction:column;align-items:stretch;flex:1 1 auto;min-height:0;overflow:hidden}',
    ':root[data-tab-dock="left"] .tab-region,:root[data-tab-dock="right"] .tab-region{flex-direction:column;align-items:stretch}',
    ':root[data-tab-dock="left"] .tab-group-body,:root[data-tab-dock="right"] .tab-group-body{flex-direction:column;align-items:stretch}',
    ':root[data-tab-dock="left"] [role="tab"],:root[data-tab-dock="right"] [role="tab"]{flex:1 1 auto;justify-content:flex-start}',
    ':root[data-tab-dock="left"] .tab-wrap,:root[data-tab-dock="right"] .tab-wrap{justify-content:space-between}',
